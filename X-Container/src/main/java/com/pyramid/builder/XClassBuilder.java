...
public class XClassBuilder {
            ...
            if (field.isAnnotationPresent(XJarAnnotation.class)) {
                ...
                try {
                    ...
                    if (field.isAnnotationPresent(XClassAnnotation.class)) {
                        XClassAnnotation xcea = (XClassAnnotation) field
                                .getAnnotation(XClassAnnotation.class);
     ...
     * @return
     */
    public static Object reflectClass2Object(XClassAnnotationEntity xClassEntity,
            String className) {
        try {
