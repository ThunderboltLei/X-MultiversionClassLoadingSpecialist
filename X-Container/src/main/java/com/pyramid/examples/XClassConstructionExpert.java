...
public class XClassConstructionExpert extends AbstractXClassConstruction<XClassConstructionExpert> {
	...
	public void construct() {
		...
		LOG.info("--->>>>> {}\n{}", xEntity11.getKey(), JSON.toJSONString(xEntity11.getXClassLoader()));
		XClassLoader xLoader = xEntity11.getXClassLoader();
		LOG.info("--->>> {}", xLoader.getURLs().length);

		try {
			Class c11_KafkaProducer = xLoader.loadClass("org.apache.kafka.clients.producer.KafkaProducer");
			Class c11_StringSerializer = xLoader.loadClass("org.apache.kafka.common.serialization.StringSerializer");
			Class c11_DefaultPartitioner = xLoader
					.loadClass("org.apache.kafka.clients.producer.internals.DefaultPartitioner");
			Class c11_ProducerRecord = xLoader.loadClass("org.apache.kafka.clients.producer.ProducerRecord");
