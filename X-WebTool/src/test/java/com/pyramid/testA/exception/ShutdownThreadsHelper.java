...
public class ShutdownThreadsHelper {
     ...
     *            time to wait for thread to join after being interrupted
     * @return <tt>true</tt> if the thread is successfully interrupted,
     *         <tt>false</tt> otherwise
     */
    ...
    /**
     * @param service
     *            {@link ExecutorService to be shutdown}
     * @return <tt>true</tt> if the service is terminated, <tt>false</tt> otherwise
     ...
     * @throws InterruptedException
     */
    public static boolean shutdownExecutorService(ExecutorService service, long timeoutInMs)
            throws InterruptedException {
        if (service == null) {
            return true;
        }
